 ...
 * </pre>
 *
 * @author Domen Å oberl @ UL FRI
 * @author Jure Å½abkar  @ UL FRI
 * @version 2/2018
 */
public class SteganographicImage extends BufferedImage {
	...
	@SuppressWarnings("unused")
	private void setContentPane(JPanel ploscaAdd2) {
		// TODO Auto-generated method stub
	...
	public static void main(String[] args) {
    	System.out.println("test");
    	SteganographicImage steganographicImage = null;
		try {
			steganographicImage = SteganographicImage.loadFromFile("example.jpg");
		} catch (IOException e) {
			...
			e.printStackTrace();
    			  ...
    			  try {
					steganographicImage.setMessage("This is the hidden message.");
				} catch (SteganographicImageException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
    			/*  try {
					steganographicImage.addAttachment("file1.doc");
				} catch (IOException | SteganographicImageException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}*/
    			  try {
    			  ...
    			  /*SteganographicImage stenographicImage = null;
				System.out.println("Remaining storage: " +
    			      Integer.toString(stenographicImage.getTotalStorage() - stenographicImage.getUsedStorage()));
    			 */
    			  // Example of decoding.
